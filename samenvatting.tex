		...
		\subsubsection{\textit{Trapeziumregel}\index{Trapeziumregel (numerieke integratie)}}
			...
			\[ 
			 ...
			 \[ 
			  ...
			  Als we deze en de rechthoeksbenadering uitschrijven, zien we dat alleen de co\"efficienten foor $f(x_0)$ en $f(x_n)$ anders zijn. We concluderen dat ook de co\"efficienten bepalend kunnen zijn voor de orde.
