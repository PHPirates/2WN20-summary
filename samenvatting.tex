...
\begin{document}
	...
	\subsection{\indx{Method of manufactured solutions}}
		...
		We gaan hier van van een scalaire, lineaire, inhomogene differentiaalvergelijking $y'=\lambda y + g(t)$.
		...
		\subsection{\indx{Runge-Kutta methoden}} 
			...
			Hierdoor is ook makkelijk te zien dat dit inderdaad slechts twee effectieve $f$-evaluaties zijn.
